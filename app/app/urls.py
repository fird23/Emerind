...
urlpatterns = [
    ...
    path("blog/<int:post_id>/increment_view_count/", views.increment_view_count, name="increment_view_count"),
    path('blog/<int:post_id>/like/', views.like_blog, name='like_blog'),
